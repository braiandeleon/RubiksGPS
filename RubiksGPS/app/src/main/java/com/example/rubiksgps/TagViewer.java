...
import com.example.rubiksgps.record.ParsedNdefRecord;
...
public class TagViewer extends Activity {
    ...
    private void resolveIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            NdefMessage[] msgs;
                /*aquiiiiiiiiiiiiiiiiiiiiiiiiiiiiikkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkiiii*/
            if (rawMsgs != null) {
    ...
    void buildTagViews(NdefMessage[] msgs) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            timeView.setText("Se visitó el dia: "+TIME_FORMAT.format(now));
